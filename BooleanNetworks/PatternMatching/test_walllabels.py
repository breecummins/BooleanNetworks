...
def test0():
    ...
    print set(wl.getFirstAndNextWalls('md',paramDict['triples'],paramDict['walllabels']))==set([(0,1),(3,4)])    
    print set(wl.getFirstAndNextWalls('um',paramDict['triples'],paramDict['walllabels']))==set([(4,6)])    
    print set(wl.getFirstAndNextWalls('ud',paramDict['triples'],paramDict['walllabels']))==set([(1,4)])    
    print set(wl.getFirstAndNextWalls('uM',paramDict['triples'],paramDict['walllabels']))==set([])    
...
def test1():
    ...
    inedges=[tuple([j for j,o in enumerate(outedges) if node in o]) for node in range(len(outedges))]   
    paramDict = wl.makeAllTriples(outedges,walldomains,varsaffectedatwall)
    print set(wl.getFirstAndNextWalls('dd',paramDict['triples'],paramDict['walllabels']))==set([])    
    print set(wl.getFirstAndNextWalls('md',paramDict['triples'],paramDict['walllabels']))==set([(0,1)])    
    print set(wl.getFirstAndNextWalls('dM',paramDict['triples'],paramDict['walllabels']))==set([(2,0)])    
...
def test2():
    ...
    inedges=[tuple([j for j,o in enumerate(outedges) if node in o]) for node in range(len(outedges))]   
    paramDict = wl.makeAllTriples(outedges,walldomains,varsaffectedatwall)
    print set(wl.getFirstAndNextWalls('Mu',paramDict['triples'],paramDict['walllabels']))==set([(3,2),(6,5)])    
    print set(wl.getFirstAndNextWalls('md',paramDict['triples'],paramDict['walllabels']))==set([(0,1)])    
    print set(wl.getFirstAndNextWalls('uM',paramDict['triples'],paramDict['walllabels']))==set([])    
    print wl.pathDependentStringConstruction(0,1,3,walldomains, outedges,varsaffectedatwall[1],inedges)==['um']
...
def test3():
    ...
    inedges=[tuple([j for j,o in enumerate(outedges) if node in o]) for node in range(len(outedges))]   
    paramDict = wl.makeAllTriples(outedges,walldomains,varsaffectedatwall)
    print set(wl.getFirstAndNextWalls('Muu',paramDict['triples'],paramDict['walllabels']))==set([])    
    print set(wl.getFirstAndNextWalls('ddm',paramDict['triples'],paramDict['walllabels']))==set([])    
    print set(wl.getFirstAndNextWalls('uMd',paramDict['triples'],paramDict['walllabels']))==set([(1,0)])    
    print set(wl.getFirstAndNextWalls('dmu',paramDict['triples'],paramDict['walllabels']))==set([(4,5)])    
...
def test4():
    ...
    inedges=[tuple([j for j,o in enumerate(outedges) if node in o]) for node in range(len(outedges))]   
    paramDict = wl.makeAllTriples(outedges,walldomains,varsaffectedatwall)
    print set(wl.getFirstAndNextWalls('um',paramDict['triples'],paramDict['walllabels']))==set([(2,5),(3,6)])    
    print set(wl.getFirstAndNextWalls('dd',paramDict['triples'],paramDict['walllabels']))==set([])    
...
def test5():
    ...
    paramDict = wl.makeAllTriples(outedges,walldomains,varsaffectedatwall)
    print set(wl.getFirstAndNextWalls('mdd',paramDict['triples'],paramDict['walllabels']))==set([(0,3),(3,7),(4,8),(4,6)])
    print set(wl.getFirstAndNextWalls('umd',paramDict['triples'],paramDict['walllabels']))==set([(7,9),(8,10)])
