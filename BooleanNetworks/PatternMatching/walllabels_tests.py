...
def testme():
    ...
    print mwl.pathDependentStringConstruction3(inds.index(8),inds.index(10),inds.index(13),walldomains, outedges,varsaffectedatwall[inds.index(10)])==['um']
    print mwl.pathDependentStringConstruction3(inds.index(11),inds.index(6),inds.index(3),walldomains,outedges,varsaffectedatwall[inds.index(10)])==['dd']
    print mwl.pathDependentStringConstruction3(inds.index(13),inds.index(11),inds.index(6),walldomains,outedges,varsaffectedatwall[inds.index(10)])==['dM']    
